...
#define DEF_NUM_CHANNELS (3)
     ...
     * {Shield line, Y-line, Charge Share Delay, NODE_RSEL_PRSC(series resistor, prescaler), NODE_G(Digital Gain), filter level}
     */
#define NODE_0_PARAMS																									\
	{																													\
		X_NONE, Y(23), 30,  NODE_GAIN(GAIN_1),FILTER_LEVEL_4				\
	}
#define NODE_1_PARAMS																									\
	{																													\
		X_NONE, Y(12), 30,  NODE_GAIN(GAIN_1),FILTER_LEVEL_4				\
	}
#define NODE_2_PARAMS																									\
	{																													\
		X_NONE, Y(24),  30,  NODE_GAIN(GAIN_1),FILTER_LEVEL_4				\
	}
...
{                                                                                                              \
    SCROLLER_TYPE_SLIDER, 0, 3,                            \
		SCROLLER_RESOL_DEADBAND(SCR_RESOL_8_BIT, SCR_DB_1_PERCENT),3,10\
}
